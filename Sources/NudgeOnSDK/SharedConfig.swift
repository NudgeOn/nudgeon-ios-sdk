...
enum SharedConfig {
    static let sdkKeyKey = "nudgeon.shared.sdk_key"
    static let apiHostKey = "nudgeon.shared.api_host"
    static let deviceIdKey = "nudgeon.shared.device_id"
    static let anonIdKey = "nudgeon.shared.anon_id"
    static let externalIdKey = "nudgeon.shared.external_id"

    static func mirror(config: NudgeOnConfig, deviceId: String, anonId: String, externalId: String?) {
