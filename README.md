...
> **파트너 베타 후보입니다.** SPM 0.2.5는 공개 배포되었으며, CocoaPods core/NSE는
...
- **인앱 웹 소스 테스트** — [NudgeOnInApp 연결 안내](IN-APP-TESTING.md) (0.2.5)

## 설치 (Swift Package Manager)

```swift
.package(url: "https://github.com/NudgeOn/nudgeon-ios-sdk.git", from: "0.2.5")
```
...
- **M4** ✅ 계약 테스트(`contract-tests/`·`Tests/NudgeOnContractTests`)·실행 가능한 UIKit 데모 앱(`Examples/NudgeOnDemo`) / ✅ SPM 0.2.5 배포 / ☐ CocoaPods trunk 게시 (준비·lint 완료)
